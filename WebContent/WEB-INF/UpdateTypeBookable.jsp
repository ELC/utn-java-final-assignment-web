...
<form name="UpdateTypeBookable" action="${pageContext.request.contextPath}/Update/TypeBookable" method="post">
                ...
                <button class="btn btn-lg btn-primary btn-block" type="submit">UpdateTypeBookable</button>
